...
export function telegramPurchaseUrl(book:Book){const username="n0rdi64";return`https://t.me/${username}?text=${encodeURIComponent(`سلام، برای خرید کتاب «${book.title}» درخواست دارم.`)}`;}
